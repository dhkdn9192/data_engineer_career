...
- metadata-file 예시
  - [Chapter_2/metadata-file.json](https://github.com/developer-advocacy-dremio/definitive-guide-to-apache-iceberg/blob/main/Resources/Chapter_2/metadata-file.json) (이해를 돕기 위해 json으로 작성했으나 실제로 Iceberg에서 manifest-file은 Avro 포맷으로 저장됨)
